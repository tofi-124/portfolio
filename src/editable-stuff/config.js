...
const getInTouch = {
  ...
  message:
    "I'm seeking full-stack web development opportunities right now! Please write me at if you know of any openings, if you have any websites you want me to build(Shopify, Wordpress..), or if you simply want to say hello",
